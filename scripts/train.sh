...
uv run python train.py --batch_size 1 --accumulation_steps 128 --max_steps 20000 --save_interval 10 --log_interval 1 --test_interval -1 --test_games 4 --win_reward 1.0 --point_reward 0.1 --damage_reward 0.01 --timeout_reward 0.0 --league_decks_student "train_data/teacher.csv" --league_decks_teacher "train_data/teacher.csv" --enable_profiler --transformer_layers 2 --transformer_heads 2 --transformer_embed_dim 8 --transformer_seq_len 4 "$@" 
